class AttractionsController < ApplicationController
  ...
  def ride
    ride = @attraction.rides.new(user: current_user)
    result = ride.take_ride
    redirect_to current_user, notice: result
  end
  ...
  private
    ...
    def attraction_params
      params.fetch(:attraction, {}).permit(:name, :tickets, :nausea_rating, :happiness_rating, :min_height)
    end
end
